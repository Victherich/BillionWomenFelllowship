    ...
    <HeroContainer ref={heroRef}>
      ...
      <HeroText>
        ...
        <Flip triggerOnce={false} duration={2000}>
          <HeroTitle>BILLION WOMEN GLOBAL FELLOWSHIP</HeroTitle>
        </Flip>
        {/* Using a Fade animation for a smooth, subtle effect */}
        <Zoom triggerOnce={false} delay={500} duration={3000}>
          <HeroTitle2>Empowering Women Globally</HeroTitle2>
        </Zoom>
        {/* Using a Zoom animation for a strong, impactful effect */}
        <Zoom triggerOnce={false} delay={1000} duration={3000}>
          <HeroSubtitle>Join the Billion Women Fellowship, a global initiative to empower and connect women leaders across the world.</HeroSubtitle>
        </Zoom>
      </HeroText>
    </HeroContainer>
  );
